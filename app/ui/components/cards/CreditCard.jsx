...
const CreditCard = ({ cardNumber, cardHolder, cardExpiration, cardCvv, cardBank }) => {
  ...
  return (
    ...
    >
      <View style={styles.cardDetailsContainer}>
        ...
        <Text style={styles.cardDetailText}>{cardHolder}</Text>
        <Text style={styles.cardDetailText}>{`CVV: ${cardCvv}`}</Text>
      </View>
